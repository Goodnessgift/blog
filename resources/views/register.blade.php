...
@section('content')
    ...
    <main>
        <div class="d-flex justify-content-center align-items-center">
            ...
            <form action="/register" method="POST" class="m-3 w-50" enctype="multipart/form-data"
                ...
                <div class="form-group mb-3">
                    <label for="user_name" style="font-weight: bold; margin-bottom: .5em; display: block;">Full
                        Name:</label>
                    <input type="text" name="users_name" class="form-control" placeholder="Enter your full name"
